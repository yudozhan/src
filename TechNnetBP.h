...
public:
	...
	int m_nInputValue;//the count of input viabale
	int m_nOutputValue;//the count of output viabale
...
//	float* m_pWeight2[COUNT_NEURAL_LAY2];
//	float* m_pWeight3[COUNT_NEURAL_OutMax];
	float m_fError;
	int m_nRepeat;
	float m_a;//a
	float m_n;//nnn
