...
/////////////////////////////////////////////////////////////////////////////
// CSelectStockHsDetail2 message handlers
...
//		int nItem = m_StockList.GetNextSelectedItem(pos);
		CString strID=sSymbolArray[i].m_chSymbol ;//.GetItemText(nItem,1);
		CString strName = "";
		CReportData* pdt = 0;
		if(CMainFrame::m_pDoc ->m_sharesInformation.Lookup(strID.GetBuffer (0),pdt,sSymbolArray[i].m_nSymbolKind))
			strName = pdt->name;
		if(!pdt) 
		{
			ASSERT(FALSE);
