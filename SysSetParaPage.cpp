...
/////////////////////////////////////////////////////////////////////////////
// CTaiSysSetParameterPage property page
...
//	DDX_Control(pDX, IDC_LTP_RATE, m_ltp_rateC);
//	DDX_Control(pDX, IDC_CJL_RATE, m_cjl_rateC);
...
//	DDX_Text(pDX, IDC_CJL_RATE, m_cjl_rateV);
//	DDV_MinMaxFloat(pDX, m_cjl_rateV, 0.f, 1.f);
//	DDX_Text(pDX, IDC_LTP_RATE, m_ltp_rateV);
//	DDV_MinMaxFloat(pDX, m_ltp_rateV, 0.f, 1.f);
	//}}AFX_DATA_MAP
}
...
/////////////////////////////////////////////////////////////////////////////
// CTaiSysSetParameterPage message handlers
...
BOOL CTaiSysSetParameterPage::OnInitDialog() 
{
	...
	//added by qyp for wide net version at 2001.10.10
...
{
//	HtmlHelp(m_hWnd,"stock.chm",HH_HELP_CONTEXT,IDD_SET_PARAM);
//	return TRUE;
