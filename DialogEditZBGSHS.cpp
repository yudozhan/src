...
/*	"FINANCE(1)---财务数据(总股本(万股))",0,"",
	"FINANCE(2)---财务数据(国家股(万股))",0,"",
	"FINANCE(3)---财务数据(发起人法人股(万股))",0,"",
	"FINANCE(4)---财务数据(法人股(万股))",0,"",
	"FINANCE(5)---财务数据(职工股(万股))",0,"",
	"FINANCE(6)---财务数据(公众A股(万股))",0,"",
	"FINANCE(7)---财务数据(流通A股(万股))",0,"",
	"FINANCE(8)---财务数据(Ｈ股(万股))",0,"",
	"FINANCE(9)---财务数据(B股(万股))",0,"",
	"FINANCE(10)---财务数据(转配股(万股))",0,"",
	"FINANCE(11)---财务数据(总资产(万元))",0,"",
	"FINANCE(12)---财务数据(流动资产(万元))",0,"",
	"FINANCE(13)---财务数据(长期投资(万元))",0,"",
	"FINANCE(14)---财务数据(固定资产(万元))",0,"",
	"FINANCE(15)---财务数据(无形资产(万元))",0,"",
	"FINANCE(16)---财务数据(流动负债(万元))",0,"",
	"FINANCE(17)---财务数据(长期负债(万元))",0,"",
	"FINANCE(18)---财务数据(股东权益(万元))",0,"",
	"FINANCE(19)---财务数据(资本公积金(万元))",0,"",
	"FINANCE(20)---财务数据(盈余公积金(万元))",0,"",
	"FINANCE(21)---财务数据(每股净值(元))",0,"",
	"FINANCE(22)---财务数据(股东权益比率(%))",0,"",
	"FINANCE(23)---财务数据(每股公积金(元))",0,"",
	"FINANCE(24)---财务数据(主营业务收入(万元))",0,"",
	"FINANCE(25)---财务数据(主营业务利润(万元))",0,"",
	"FINANCE(26)---财务数据(其它业务利润(万元))",0,"",
	"FINANCE(27)---财务数据(利润总额(万元))",0,"",
	"FINANCE(28)---财务数据(净利润(万元))",0,"",
	"FINANCE(29)---财务数据(未分配利润(万元))",0,"",
	"FINANCE(30)---财务数据(每股收益(元))",0,"",
	"FINANCE(31)---财务数据(净资产收益率(%))",0,"",
	"FINANCE(32)---财务数据(每股未分配利润(元))",0,"",
	"FINANCE(33)---财务数据(每股净资产(元))",0,"",*/
