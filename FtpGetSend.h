...
class FtpGetSend : public CWinThread
{
DECLARE_DYNCREATE(FtpGetSend)
protected:
FtpGetSend(); // protected constructor used by dynamic creation
...
private:
	...
	// static BOOL PostMessageToLocalWnd( UINT message, WPARAM wParam = 0, LPARAM lParam = 0 );
...
#endif // !defined(AFX_FTPGETSEND_H__2A5CD434_E987_4FAA_BF9F_9433D6842070__INCLUDED_)
