...
public:
	...
	void	ScrollDown();
	void	Draw();
	void	SetColor(BOOL bReDraw,COLORREF crBack=RGB(0,0,0), COLORREF crFrame=RGB(255,0,0), COLORREF crArrow=NULL,COLORREF crThumb=NULL,COLORREF crChannel=NULL);
...
//	int			m_nBitmapWidth;			// width of arrow and thumb bitmaps
	...
	CRect m_rcArrow1,m_rcThumb,m_rcChannel,m_rcArrow2;
	...
	void		SetPositionFromThumb(POINT point);
